...
- **NEVER modify files under `.github/workflows/` or `.github/prompts/`.** These are CI/CD infrastructure managed by the maintainer. If the fix requires workflow changes, write `unable.md` explaining what needs to change and why.
