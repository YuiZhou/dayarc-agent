...
3. Within each cluster, write one sentence per activity describing *what* was done. **Write all descriptions in the language specified by `config.preferences.locale` (default: `en`). For `zh`: use Simplified Chinese professional tone.**
